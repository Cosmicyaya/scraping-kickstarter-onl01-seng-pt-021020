...

kickstarter_scraper.rb
Last saved at Mar 28, 2020 1:27:09 pm
...
Just to check our assumptions, let's add a require 'pry' at the top of our file, and add binding.pry after the last line. Add a call to the create_project_hash method at the bottom of the file.
...
create_project_hash
Then type ruby kickstarter_scraper.rb into your terminal. This should drop us into Pry, so that we can play around.
